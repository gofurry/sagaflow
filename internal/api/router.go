...
func (s *Server) RegisterRoutes(app *fiber.App) {
	...
	p.Get("/projects/:id/voice-profiles", s.listVoiceProfiles)
	p.Post("/projects/:id/voice-profiles", s.createVoiceProfile)
	...
	p.Get("/projects/:id/prompt-presets", s.listPromptPresets)
	p.Post("/projects/:id/prompt-presets", s.createPromptPreset)

  ...
  return <div className="login-shell">
    <Card className="login-card" variant="borderless">
      <Space orientation="vertical" size={22} style={{ width: '100%' }}>
		...
		{!status.initialized ? <Form layout="vertical" onFinish={(values) => onSetup(values.username, values.display_name, values.password)} requiredMark={false}>
		...
		</Form> : <Form layout="vertical" onFinish={(values) => onLogin(values.username, values.password)} requiredMark={false}>

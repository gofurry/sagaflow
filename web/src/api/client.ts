...
export const api = {
  ...
  importGenerationReferenceURL: (projectID: ID, url: string) => request<GenerationReferenceUpload>(`/projects/${projectID}/generation-reference-urls`, { method: 'POST', body: body({ url }) }),

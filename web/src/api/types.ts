...
export interface PromptPreset { id: ID; project_id: ID; model_id: ID | null; model_preset_id: ID | null; name: string; description: string; capability: Exclude<Capability, 'multimodal'>; content: string; created_at: string; updated_at: string }
...
export interface VoiceProfile { id: ID; project_id: ID; provider_id: ID; model_id: ID; provider_code: string; model_identifier: string; name: string; description: string; voice_id: string; status: 'ready' | 'error'; source_name: string; source_mime_type: string; source_file_size_bytes: number; prompt_text: string; preview_mime_type: string; preview_file_size_bytes: number; activated_at: string | null; metadata: Record<string, unknown>; created_at: string; updated_at: string }
